...
export const styles = StyleSheet.create({
  ...
  avatarPlaceholder: { alignItems: "center", justifyContent: "center", backgroundColor: colors.primaryMuted },
  avatarLetter: { color: colors.title, fontSize: 36, fontWeight: "800" },
  name: { color: colors.text, fontSize: 24, fontWeight: "800", marginTop: 12 },
  city: { color: colors.textMuted, fontSize: 14, marginTop: 4 },
  metaLine: { color: colors.title, fontSize: 13, fontWeight: "700", marginTop: 6 },
